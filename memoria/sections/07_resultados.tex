...
La diferencia media de Ukeire, calculada como el Ukeire del descarte observado menos el Ukeire del descarte predicho, pasa de $-0,3695$ para el checkpoint 100k a $0,1592$ para el modelo de 500.000 estados. Un valor negativo indica que, en promedio, el descarte predicho conserva ligeramente más fichas útiles que el descarte observado; un valor positivo indica lo contrario. No obstante, esta media debe interpretarse conjuntamente con el Shanten, puesto que una mejora de Ukeire no compensa necesariamente una pérdida de Shanten.
